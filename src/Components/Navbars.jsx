...
const Navbars = () => {
    ...
    <Navbar.Brand><img className="Logo" src="https://www.pngfind.com/pngs/m/535-5356461_imagenes-de-natacion-png-transparent-png.png" alt= "Logo" />Navbar</Navbar.Brand>
